...
Also, since Chrome likes to cache CSS files, you can hard reload by pressing shift when clicking the reload button and that will grab the newest version.
